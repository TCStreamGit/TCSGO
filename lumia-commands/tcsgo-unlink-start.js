async function () {
  ...
  /*
   * Description: Start An Unlink Session For A Discord Account.
   * Command Name: tcsgo-unlink-start
   * Aliases: None
   * Usage Examples:
   * - tcsgo-unlink-start
   */
  ...
  logMsg(`[UNLINK] Vars | eventId=${eventId} | platform=${platform} | username=${platformUsername} | target=${targetDiscordUsername}`);
